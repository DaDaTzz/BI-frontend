...
import {getChartByAiUsingPOST} from "@/services/da/chartController";
    ...
    return (
        <div className={"add-chart"}>
            <Row gutter={24}>
                    ...
                    <Card title="智能分析">
                        ...
                        >
                            <Form.Item name="goal" label="分析目标" rules={[{required: true, message: '请输入分析目标!'}]}>
                                <TextArea placeholder='请输入你的分析需求，例如：分析网站的用户增长情况'/>
                            </Form.Item>
                ...
                <Col span={12}>
                    <Card title="分析结论">
                        {chart?.genResult ?? <div>请先提交数据分析</div>}
                        <Spin spinning={submitting} />
                    </Card>
                    <Divider />
                    <Card title="可视化图表">
                        {
                            option ? <ReactEcharts option={option}/> : <div>请先提交数据分析</div>
